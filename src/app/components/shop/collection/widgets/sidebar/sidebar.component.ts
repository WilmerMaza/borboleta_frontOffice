...
@Component({
    ...
    imports: [CommonModule, NgbModule, TranslateModule, CollectionAttributeFilterComponent,
        CollectionPriceFilterComponent, CollectionFilterComponent, CollectionCategoryFilterComponent,
        CollectionBrandFilterComponent, SkeletonCollectionSidebarComponent],
